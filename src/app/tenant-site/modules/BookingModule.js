...
//   // console.log("Rendering BookingModule with data:", data, "and settings:", propSettings, "for tenantId:", tenantId, "domain:", domain);
...
//           // Prefer explicit slug from API if available
//           if (s.slug) {
...
//           {resolveTranslated({ en: "Choose Your Therapist", ar: "اختر المعالج", ur: "اپنا تھراپسٹ منتخب کریں" }, lang)}
//         </h3>
...
//           </p>
//           <p className="text-sm text-gray-500">
//             {resolveTranslated({ en: "First available therapist", ar: "أول معالج متاح", ur: "پہلا دستیاب تھراپسٹ" }, lang)}
//           </p>
//         </button>
...
//         // Detect if ALL slots are unavailable بسبب provider
...
//                     onClick={() => {
//                       if (!isAvailable) return; // 🚫 hard stop
//                       onTimeSelect(time);
//                     }}
//                     className={`
...
//                         ? "Provider unavailable — select another staff"
//                         : "Already booked"}
//                     </span>
//                   )} */}
...
//         </button>
//         {error && (
//           <div className="max-w-lg mx-auto mb-4 p-4 bg-red-50 border border-red-200 rounded-xl text-red-700 text-sm">
//             {error}
//           </div>
//         )}
//       </div>
...
export default function BookingModule({ data, settings: propSettings, tenantId, domain, lang: propLang }) {
  ...
  useEffect(() => {
    ...
    saveBookingState(domain, {
      ...
      staffObj: selectedStaff || null,          // lightweight – name/id/photo only
