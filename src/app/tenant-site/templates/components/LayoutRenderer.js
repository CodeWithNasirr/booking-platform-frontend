...
/**
 * LayoutRenderer (template preview)
 *
 * Delegates entirely to the domain LayoutRenderer so both
 * template previews and live tenant sites share identical
 * section components, data normalization, and module mapping.
 */
export { default } from "../../[domain]/LayoutRenderer";
