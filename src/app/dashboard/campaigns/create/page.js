...
//   { key: '{{whatsapp_name}}', label: 'Whatsapp Name' },
//   { key: '{{imported_name}}', label: 'Imported Name' },
// ]
...
//     if (!audience) e.audience = 'Please select a targeted audience.'
//     if (!asDraft && !termsAccepted) e.terms = 'You must accept the terms to send.'
//     if (content.length > MAX_CONTENT_LENGTH) e.content = `Message too long (${content.length}/${MAX_CONTENT_LENGTH}).`
//     setErrors(e)
//     return Object.keys(e).length === 0
//   }
...
//     // Check WA before send (not for draft)
//     if (!asDraft && !waStatus?.connected) {
//       setErrors({ terms: 'WhatsApp is not connected. Please link your WhatsApp first.' })
//       return
//     }
...
//     // 10MB limit
//     if (file.size > 10 * 1024 * 1024) {
//       setErrors((prev) => ({ ...prev, attachment: 'File must be under 10MB.' }))
//       return
//     }
...
//           <p className="text-sm text-gray-500 mt-1">
//             Home → Campaigns → {editId ? 'Edit' : 'Create'}
//           </p>
//         </div>
//         <button onClick={() => router.push('/dashboard/campaigns')}
//           className="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-gray-300 text-gray-700 font-medium hover:bg-gray-50 text-sm">
...
//           </h2>
//           <p className="text-sm text-gray-600">
//             Here you can {editId ? 'edit your' : 'create a new'} campaign to send messages to your customers
//           </p>
//         </div>
...
//                     ) : audienceCount !== null ? (
//                       <span className="text-xs text-gray-500">
//                         {audienceCount.toLocaleString()} recipient{audienceCount !== 1 ? 's' : ''} matched
//                       </span>
//                     ) : null}
//                   </div>
//                 )}
...
//             {/* Schedule */}
//             <div>
//               <label className="block text-sm font-medium text-gray-700 mb-2">Start at</label>
//               <div className="relative">
//                 <input
//                   type="datetime-local"
//                   value={scheduledAt}
...
//               <p className="text-xs text-green-600 mb-2">
//                 You can attach an image, video or PDF file to the campaign
//               </p>
...
//                 <span className="text-xs text-amber-800 leading-relaxed">
//                   <span className="font-bold">⚠️</span>{' '}
//                   By clicking on the start button, you agree to the terms and conditions of the campaign.
//                   Campaigns can lead to your WhatsApp account being banned if you send spam messages.
//                 </span>
//               </label>
//               {errors.terms && <p className="text-xs text-red-600 mt-2 ml-7">{errors.terms}</p>}
//             </div>
...
//                   </div>
//                   <div className="flex-1">
//                     <p className="text-white text-sm font-medium">الجميل</p>
//                     <p className="text-gray-400 text-[10px]">متصل</p>
//                   </div>
//                 </div>
...
//                   <div className={`w-2 h-2 rounded-full ${waStatus?.connected ? 'bg-green-500' : 'bg-red-500'}`} />
//                   {waStatus?.connected
//                     ? `WhatsApp connected (${waStatus.phone})`
