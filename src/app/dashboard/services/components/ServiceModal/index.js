    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-3xl bg-white rounded-2xl shadow-2xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6">
          {activeTab === "basic" && (
            <BasicTab form={form} setForm={setForm} categories={categories} />
          )}
        ...
        <div className="px-6 py-4 border-t flex justify-end gap-3">
          ...
          <button
            onClick={onSave}
            className="px-5 py-2.5 rounded-xl text-white bg-gradient-to-br from-[#8B1E3F] to-[#A8325A] hover:opacity-90 font-medium"
          >
