  ...
  const fetchBookings = useCallback(async (isRefresh = false) => {
    try {
      ...
      return {
        ...
        currency: booking.currency,          // <-- ADD THIS
    ...
    <DashboardLayout pageName={t('bookings_page_title')}>
      <div className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          ...
          <StatCard
            icon={DollarSign}
            label={t('bookings_stat_week')}
            value={`${stats.thisWeek} ${bookings[0]?.currency ?? ""}`}
            color="bg-[#a855f7]"
          />
        </div>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-col md:flex-row md:items-start justify-between mb-2 gap-2">
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        <span className="text-base md:text-[18px] text-[#101828] font-bold">
