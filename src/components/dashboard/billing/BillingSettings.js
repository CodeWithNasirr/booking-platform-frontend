...
//   const [actionLoading, setActionLoading] = useState(null); // plan tier being acted on
//   const [billingInterval, setBillingInterval] = useState("month");
//   const [checkoutStatus, setCheckoutStatus] = useState(null); // 'success' | 'cancelled'
...
//   // ── Handle upgrade / downgrade / subscribe (Stripe Checkout or local) ──
...
//       // Free plan → handled locally, just refresh UI
//       if (data.free_plan) {
//         await fetchData();
//         return;
//       }
...
//       if (data.upgraded) {
//         setCheckoutStatus("success");
//         // instant upgrade → just refresh data
...
//   // ── Open Stripe Billing Portal (manage, cancel, update payment) ──
